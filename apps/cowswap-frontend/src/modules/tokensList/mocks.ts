...
export const listsMock: ListState[] = [
  {
    source:
      'https://tokenlists.org/token-list?url=https://raw.githubusercontent.com/chainlink-hack-2023/token-lists/main/src/public/CowSwapGoerli.json',
    list: {
      name: 'CowSwap Goerli',
      logoURI: 'https://gnosis.mypinata.cloud/ipfs/Qme9B6jRpGtZsRFcPjHvA5T4ugFuL4c3SzWfxyMPa59AMo',
...
export const importListsMock: ListState = {
  ...
  list: {
    name: 'CoW Swap',
    logoURI: 'https://raw.githubusercontent.com/chainlink-hack-2023/token-lists/main/src/public/images/list-logo.png',
